...
public class SwiftAppcenterBundlePlugin: NSObject, FlutterPlugin {
    static let methodChannelName = "com.github.cavecafe.appcenter_bundle";
    static let instance = SwiftAppcenterBundlePlugin();
